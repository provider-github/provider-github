...
func (in *OrganizationVariableParameters) DeepCopyInto(out *OrganizationVariableParameters) {
	*out = *in
	...
	if in.SelectedRepositories != nil {
		...
		*out = make([]VariableSelectedRepo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VariableSelectedRepo) DeepCopyInto(out *VariableSelectedRepo) {
	*out = *in
	if in.RepoRef != nil {
		in, out := &in.RepoRef, &out.RepoRef
		*out = new(v1.Reference)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VariableSelectedRepo.
func (in *VariableSelectedRepo) DeepCopy() *VariableSelectedRepo {
	if in == nil {
		return nil
	}
	out := new(VariableSelectedRepo)
	in.DeepCopyInto(out)
	return out
}
